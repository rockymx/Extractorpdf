/*
  # Fix get_all_users_admin function to include is_active field

  1. Changes
    - DROP the existing function completely
    - Recreate with is_active boolean field in RETURNS TABLE
...
-- Drop the existing function completely to allow changing the return type
DROP FUNCTION IF EXISTS get_all_users_admin();

-- Recreate the function with is_active field
